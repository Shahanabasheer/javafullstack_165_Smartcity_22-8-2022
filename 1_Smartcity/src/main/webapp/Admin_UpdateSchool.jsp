...
#updateSchool_div1 label {
	...
	clear: left;
	text-align: left;
	pupdateing-right: 10px;
	pupdateing-bottom: 10px;
}
...
<body id="body_Updateschool">
	...
	<div class="update_school" id="update_school">
		...
		<form action="update_School.jsp?School_Id=<%=s_id%>" method="post" name="updateSchoolFM"
			id="updateSchoolFM" onsubmit="return formValidation()">
					...
					<div id="updateSchool_div5">
						...
						<script>
							...
							while (currentYear >= earliestYear) {
								...
								dateDropdown.update(dateOption);
								currentYear -= 1;
							}
						</script>
					</div>
