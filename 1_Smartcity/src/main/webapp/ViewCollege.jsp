		...
		<div class="admin_viewCollege" id="">
			...
			<div class="viewCollege_div1" id="viewCollegeDiv1">
				<label for="College_id"><input type="hidden" id="College_Id"
					...
					for="Collegename">${s.getCollegeName()}</label><br> <span
			...
			<div class="viewCollege_div2" id="viewCollegeDiv2">
				...
				<%
 				...
 				%>
 					<a href="Admin_ViewMoreCollege_t.jsp?College_Id=${c.getCollege_id()}"><input
						type="button" name="viewMore" id="view_more" value="View More"></a>
				<%
					} else {
				%>	
					<a
					href="User_ViewMoreCollege_t.jsp?College_Id=${c.getCollege_id()}">	
					<input type="button" name="viewMore" id="view_more" value="View More"></a>
				<%
					}
				%>
				</label>
