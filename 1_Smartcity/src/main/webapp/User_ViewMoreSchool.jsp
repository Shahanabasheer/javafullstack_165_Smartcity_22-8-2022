...
<body id="body_viewMoreSchool">
	...
	<div class="viewMoreSchool_d2" id="viewMoreSchool_d2">
		...
		<form action="add_Message.jsp?Edu_name=${s.getSchoolName()}" 
			method="post"
			name="enquiryFM" onsubmit="return enqValidation()">
			<label>Name:<input type="text" name="name" id="name"></label><br><span
				id="e_1"></span><br> <label>Email:<input type="email"
				name="email" id="email"></label><br><span id="e_2"></span><br>
			<label>Phone<input type="tel" name="phoneNumber"
				id="phoneNumber"></label><br>
			<span id="e_3"></span><br> <label>Your message</label><br>
			<textarea rows="3" cols="30" name="textMsg" id="textMsg"></textarea>
			<br><span id="e_4"></span><br> <input type="submit" name="submit" value="Submit Enquiry">
		</form>
	</div>
